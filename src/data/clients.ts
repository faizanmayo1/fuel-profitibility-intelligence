...
export const clients: Client[] = [
  { id: 'redhill', name: 'Redhill Constructions', industry: 'Construction', segment: 'High value', arr: 2_400_000, health: 'Critical', healthScore: 38, scoreDelta: -14, topAlert: 'Cash shortfall in 21 days', integration: 'Xero', lastSyncMin: 4, advisor: 'Fazal M.', recRevenueGrowth: -3.2, marginPct: 18.4 },
  { id: 'mintwell', name: 'Mintwell Retail Co.', industry: 'Retail', segment: 'High value', arr: 4_800_000, health: 'Critical', healthScore: 41, scoreDelta: -11, topAlert: 'AR >60d aged $187k', integration: 'Xero', lastSyncMin: 2, advisor: 'Fazal M.', recRevenueGrowth: 4.1, marginPct: 12.1 },
  ...
  { id: 'arcfield', name: 'Arcfield Engineering', industry: 'Prof. Services', segment: 'High value', arr: 3_100_000, health: 'At Risk', healthScore: 61, scoreDelta: -5, topAlert: 'Payroll outpacing revenue', integration: 'Xero', lastSyncMin: 3, advisor: 'Fazal M.', recRevenueGrowth: 9.2, marginPct: 19.8 },
  ...
  { id: 'meridien', name: 'Meridien SaaS Labs', industry: 'SaaS', segment: 'Growth', arr: 6_200_000, health: 'Strong', healthScore: 84, scoreDelta: +4, topAlert: null, integration: 'Xero', lastSyncMin: 1, advisor: 'Fazal M.', recRevenueGrowth: 38.2, marginPct: 64.1 },
  ...
  { id: 'ironbark', name: 'Ironbark Build Co.', industry: 'Construction', segment: 'Stable', arr: 4_100_000, health: 'Stable', healthScore: 69, scoreDelta: -3, topAlert: 'Subcontractor cost ↑ 9%', integration: 'Xero', lastSyncMin: 9, advisor: 'Fazal M.', recRevenueGrowth: 5.1, marginPct: 14.8 },
